...
var ABOUT_RESOURCES = [
      {
        ...
        "titleFriendly":"",
        "summary":"???? Android 5.0 Lollipop?????????????????? Android ??? ??????????????????????????????? API???????? Android ???????????????????????????????????????????? ???????????? API???? Android 5.0 API ?? ????????????? Android 5.0 ?????? www.android.com ? Android…",
      ...
      }, 
      {
        "title":"Android Lollipop",
        "titleFriendly":"",
        "summary":"???????????? ??? Android 5.0 Lollipop ? ????? ????? ? ??????????? ?????? ???????????? ??????? Android! ? ???? ?????? ??????????? ????????? ????? ??????? ??? ????????????? ? ?????? API ??? ?????????????. Android ?????? ???????????? ?? ?????? ??? ??????…",
      ...
      }, 
      {
        "title":"Android Lollipop",
        "titleFriendly":"",
        "summary":"Android 5.0 Lollipop ??????? Android ???????????????????????? ???????????????????????????????????????? API ?????????????? API ???????????????????????????????????????? Android ???????? ??????????? API ????????? Android 5.0 API ????????Android 5.0 ?????…",
      ...
      }, 
      {
        "title":"Android Lollipop",
        "titleFriendly":"",
        "summary":"???? Android 5.0 Lollipop????????????????? Android ??? ??????????????????????????????????? API?Android ??????????????????????????????????? ????????????? API???? Android 5.0 API ?? ????????????? Android 5.0 ???????? www.android.com ? Android 5.0 ? ????…",
      ...
      }, 
      {
        "title":"Android Lollipop",
        "titleFriendly":"",
        "summary":"????? Android ?? ?? ? ?? ?? ?? ?? ??? Android 5.0 Lollipop? ?????. ?? ?? ???? ???? ?? ??? ??? ???? ?? ?? ??? ??? API? ???? ????. ?? Android? ????, ???, ???? ???? ??? TV? ?????? ??? ? ????. ??? ??? API? ?? ??? ????? Android 5.0 API ?? ? ?????. ?? www.android.com…",
      ...
      }, 
      {
        ...
        "image":"//chart.googleapis.com/chart?chl=GL%202.0%7CGL%203.0&chf=bg%2Cs%2C00000000&chd=t%3A67.5%2C32.5&chco=c4df9b%2C6fad0c&cht=p&chs=400x250",
        "lang":"en",
        "type":"about"
      }, 
      {
...
var DISTRIBUTE_RESOURCES = [
      ...
      {
        "title":"Google Play でアプリを配信する",
        "titleFriendly":"",
        "summary":"Google Play は最もよく利用されている Android アプリストアです。クラウドと同期された強力な基盤により、ユーザーは簡単に あなたのアプリを見つけてダウンロードできます。",
        "url":"intl/ja/distribute/index.html",
        "group":"",
        "keywords": [],
        "tags": [],
        "image":"",
...
var GOOGLE_RESOURCES = [
      {
        "title":"应用内结算 API",
        "titleFriendly":"",
        "summary":"??????? API ? 3 ????????????????????????????????????????????????????????????????? API ??????????????? ????? Google Play ?????????????????????SKU????????????????? ??????? ?API ? 3 ??????????????????????? ??????????? Google Play ????????????????????????…",
      ...
      }, 
      {
        "title":"测试应用内结算",
        "titleFriendly":"",
        "summary":"Google Play ????????????????????????????? ????????????????????? Android ????????? Android ????????????????????????? Android 1.6 ?????????API ?? 4 ????????????????? Google Play ??????????????? Google Play ??????????? Google Play ???????????????????????…",
      ...
      }, 
      {
        "title":"应用内结算概述",
        "titleFriendly":"",
        "summary":"????????????????????????????????????????? ????????? API ???????? Google Play ???????????????????Google Play ????????? Google Play ???????????????????????????? Google Play ??????????????? (IPC) ? Google Play ??????????? Google Play ????????????????????…",
      ...
      }, 
      {
        "title":"管理应用内结算",
        "titleFriendly":"",
        "summary":"?????????????????????????????????????????? Google Play ???????????????????????????????????? ???? Google Play ????????????????????? Google ??????????????????????????????? Google Play ??????????????????????????????????? ?????????????? Google Play ??????…",
...
var TOOLS_RESOURCES = [
      {
        "title":"ProGuard",
        "titleFriendly":"",
        "summary":"ProGuard ??????????????????????????????????????????????????????????????? .apk ?????????????????? ProGuard ??????????????????????????????????????? ??????? ???????????? ProGuard ???? Android ??????????????????????????????????ProGuard ???????????????????…",
      ...
      }, 
      {
        "title":"发布概述",
        "titleFriendly":"",
        "summary":"?????? Android ????????????????? Android ???????????? ????????????????????? Android ?????????? ?????????????????????????? ??????????? Google Play ???????????????????????????????????????????????????? ? 1 ?????????? Android ?????? ??????????????????????…",
      ...
      }, 
      {
        "title":"准备发布",
        "titleFriendly":"",
        "summary":"???? Android ????????????????????????? Android ???????????????? ???? ???????????????? 1?? ??????????????????????????????????????????????????????????????????????????????????????????? JDK ? Android SDK ???????????????????????????????????????????????????…",
...
var TRAINING_RESOURCES = [
      ...
      }, 
      {
        "title":"构建灵活的界面",
        "titleFriendly":"",
        "summary":"???????????????????????????????? Fragment ??????????????????????? ?????????? Fragment ?????????????????????????????????? Fragment??????????????????????????? ?? FragmentManager ?????????????????????? Activity ?? Fragment??????????????? ???? Activity ??…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"TV ?????? 10 ?????????????????????? Android ??????????????????????????????????????????????????????????? ??????????????????????????? TV ?????????????????????????? ?????????TV ?????????????????????????????????????????? Android ? ??? ??TV ???????????????…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"TV ???????????????? ????????????????TV ????????????????? ???????????????????????????????? ???????????????????????????????????????????TV ?? Android ????????????????????? ????????? TV ????? ??????????????????????????????????????????????? ????????????? TV…",
      ...
      {
        "title":"Android TV アプリ開発",
        "titleFriendly":"",
        "summary":"Android TV 対応アプリ開発の手順が日本語化。",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"TV ??????????? Android ?????????????TV ????????????????GPS ???????? Android ??????????????????????????? TV ??2 ??????????????????????????????????????????????? TV ????????????????TV ??????????????????????? TV ????????????????????????????? ?????????TV ?…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"TV ?????????????????????????????????????Android ???????????????????????? TV ????????????????? TV ?????????????????????? ?????????TV ?????????????????????TV ??????????????????????????????????????? ??????????TV ?????????????????????????????????????TV ??…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"TV ????????? ???????????????????????????????????????????????????????????????? ?????????????? ?????????????????????????????????????????????? ????????? v17 leanback ???? ????? ?????????????????????? ???????????????????????? ?????????????????????? leanback…",
      ...
      }, 
      {
        "title":"TV 再生アプリのビルド",
        "titleFriendly":"",
        "summary":"???? ????????????????TV ???????????? ???????????????????????????????????????????????????? ??????????????????????????????????????????????? ??????????????????????????????????????????????????????????????????????? Android ??????????? v17 leanback ???? ???…",
      ...
      }, 
      {
        "title":"詳細ビューをビルドする",
        "titleFriendly":"",
        "summary":"v17 leanback ???? ????? ????????? ?????? ???????? ???????????????????? ??????????????????????????????????????????????????????????????????????? ????????????? ????????????????? ??????????DetailsFragment ?????????????????? ???????????????????????????????…",
      ...
      }, 
      {
        ...
        "image":"images/enterprise/work-launcher.png",
        "lang":"en",
        "type":"training"
      }, 
      {
...
var DESIGN_BY_TAG = {
    "tablet":[2,4], 
    "navigation":[2,4,8,12,13,16,19,57], 
    "layout":[2,4,38,53,54], 
    "fragment":[2], 
    "fullscreen":[3], 
    "immersive":[3], 
...
var DISTRIBUTE_BY_TAG = {
    "landing":[9,39], 
    "quality":[9,38,39,71,72,75], 
    "localizing":[13,18], 
    "publishing":[13,18,74], 
    "disttools":[13,14,17,18], 
    "promoting":[15,17], 
    "brand":[16], 
    "bugdroid":[16], 
    "assets":[16], 
    "analytics":[20,21,22,24,25,26,45,56], 
    "userbehavior":[20,21,22,24,25,26,56], 
    "in-app":[27,29], 
    "billing":[27], 
    "iap":[27,29], 
    "monetizing":[27,28,29,31,32], 
    "googleplay":[33,47,52,53,54,69], 
    "payments":[33], 
    "giftcard":[33], 
    "wear":[38,75], 
    "wearables":[38], 
    "users":[45,46,47,48,49,50], 
    "ads":[45], 
    "listing":[47], 
    "gcm":[55], 
    "engagement":[57], 
...
var GUIDE_BY_TAG = {
    ...
    "sipaudiocall":[83], 
    "telephony":[83], 
    "hostcardemulation":[85], 
    "hce":[85], 
    "hostapduservice":[85], 
    "offhostapduservice":[85], 
    "tapandpay":[85], 
    "localizing":[102], 
    "localization":[102], 
    "resources":[102], 
    ...
    "l10n":[102], 
    "photo":[110], 
    "mediarouteprovider":[112], 
    "mediacontrolintent":[112], 
    "mediaplayer":[113], 
    "soundpool":[113], 
    "audiomanager":[113], 
    "mediarecorder":[115], 
    ...
    "valueanimator":[123], 
    "objectanimator":[123], 
    "layouttransition":[123], 
    "viewpropertyanimator":[123], 
    "sdcard":[125,127], 
    "external":[125], 
    "database":[127], 
    ...
    "launcher":[129], 
    "home":[130], 
    "appwidgetprovider":[130], 
    "clipboardmanager":[136], 
    "clipdata":[136,158], 
    "input":[136,137], 
    "ime":[139], 
    "keyboard":[139], 
    "inputmethodservice":[139], 
    "accessibility":[140], 
    "alertdialog":[145], 
    "dialogfragment":[145], 
    "radiobutton":[147], 
    ...
    "tabs":[160], 
    "preference":[161], 
    "preferenceactivity":[161], 
    "preferencefragment":[161], 
    "gridview":[165], 
    "relativelayout":[166], 
    "listview":[168], 
    "linearlayout":[169], 
    "searchrecentsuggestionsprovider":[174,175], 
    "searchrecentsuggestions":[175], 
    "searchview":[176]
};

var SAMPLES_BY_TAG = {
    "basicimmersivemode":[0], 
    "elevationdrag":[1], 
    "clippingbasic":[2], 
    "textlinkify":[3], 
    "basicandroidkeystore":[4], 
    "apprestrictionenforcer":[5], 
    "donebar":[6], 
    "quiz":[7], 
    "recipeassistant":[8], 
    "mediaeffects":[9], 
    "actionbarcompat-styled":[10], 
    "horizontalpaging":[11], 
    "camera2basic":[12], 
    "watchviewstub":[13], 
    "geofencing":[14], 
    "actionbarcompat-shareactionprovider":[15], 
    "flashlight":[16], 
    "basicmultitouch":[17], 
    "bluetoothchat":[18], 
    "bluetoothlegatt":[19], 
    "advancedimmersivemode":[20], 
    "camera2video":[21], 
    "delayedconfirmation":[22], 
    "interpolator":[23], 
    "cardemulation":[24], 
    "pdfrendererbasic":[25], 
    "networkconnect":[26], 
    "navigationdrawer":[27], 
    "storageclient":[28], 
    "actionbarcompat-basic":[29], 
    "customnotifications":[30], 
    "textswitcher":[31], 
    "gridviewpager":[32], 
    "basictransition":[33], 
    "timer":[34], 
    "basicrenderscript":[35], 
    "basiccontactables":[36], 
    "swiperefreshlistfragment":[37], 
    "wearablenotifications":[38], 
    "mediarecorder":[39], 
    "basicmediadecoder":[40], 
    "speedtracker":[41], 
    "jumpingjack":[42], 
    "adaptertransition":[43], 
    "apprestrictionschema":[44], 
    "swiperefreshmultipleviews":[45], 
    "slidingtabsbasic":[46], 
    "actionbarcompat-listpopupmenu":[47], 
    "mycloud":[48], 
    "repeatingalarm":[49], 
    "customchoicelist":[50], 
    "watchface":[51], 
    "cardviewsample":[52], 
    "datalayer":[53], 
    "skeletonwearableapp":[54], 
    "basicsyncadapter":[55], 
    "synchronizednotifications":[56], 
    "displayingbitmaps":[57], 
    "findmyphone":[58], 
    "apprestrictions":[59], 
    "messagingservice":[60], 
    "basicmanagedprofile":[61], 
    "batchstepsensor":[62], 
    "mediarouter":[63], 
    "agendadata":[64], 
    "elizachat":[65], 
    "mediabrowserservice":[66], 
    "activityinstrumentation":[67], 
    "floatingactionbuttonbasic":[68], 
    "cardreader":[69], 
    "renderscriptintrinsic":[70], 
    "fragmenttransition":[71], 
    "basicgesturedetect":[72], 
    "revealeffectbasic":[73], 
    "slidingtabscolors":[74], 
    "basicaccessibility":[75], 
    "immersivemode":[76], 
    "basicnotifications":[77], 
    "basicmediarouter":[78], 
    "swiperefreshlayoutbasic":[79], 
    "hdrviewfinder":[80], 
    "customtransition":[81], 
    "activityscenetransitionbasic":[82], 
    "basicnetworking":[83], 
    "jobscheduler":[84], 
    "documentcentricrecents":[85], 
    "lnotificationssample":[86], 
    "recyclerview":[87], 
    "drawabletinting":[88], 
    "elevationbasic":[89], 
    "documentcentricrelinquishidentity":[90], 
    "embeddedapp":[91], 
    "borderlessbuttons":[92], 
    "examples":[100], 
    "code":[100]
};
...
var TRAINING_BY_TAG = {
    "tv":[28,29,30,31,32,33,34,35,36,160,288,289,291,292,294,295,296,299,300,302,303,304,305], 
    "privacy":[61], 
    "oauth":[61], 
    "accounts":[61], 
    "navigation":[64,268,274,306], 
    "input":[64,268], 
    "include":[70], 
    "merge":[70], 
    "viewstub":[70], 
    ...
    "geofence":[77], 
    "geofencing":[77], 
    "activityrecognition":[77], 
    "activitydetection":[77], 
    "gps":[77,247], 
    "support":[85,160,333], 
    "wifi":[90], 
    "network":[90,176,245,251,259,369], 
    "wireless":[90,259,369], 
    "audio":[99,197], 
    "media":[99], 
    "testing":[104], 
    ...
    "sync":[109], 
    "backup":[109], 
    "wear":[111,112,113,114,115,116,117], 
    "notifications":[117,118,119,120,121,207,208,209,210,211,212], 
    "animator":[152], 
    "views":[152], 
    "layout":[152,239], 
    "userinterface":[152,361], 
    "appindexing":[155], 
    "multiplescreens":[158,324], 
    "tablet":[160], 
    "fileprovider":[164], 
    "share":[164,180,271], 
    "contentprovider":[164], 
    "edittext":[170], 
    "accessibility":[170], 
    "intents":[180,341,342,343,344,353], 
    "cursorloader":[187], 
    "camera":[191], 
    "video":[191], 
    "picture":[191], 
    ...
    "wakelock":[330], 
    "alarmmanager":[330], 
    "wakefulbroadcastreceiver":[330], 
    "datastorage":[337,338,339,340], 
    "files":[337], 
    "sql":[337], 
    "database":[337,374], 
    "preferences":[337], 
    "activitylifecycle":[345,346,347,348,349], 
    "projectsetup":[350], 
    "sdktools":[351], 
    "emulator":[354], 
    "actionbar":[355,356,357,358,359], 
    "fragments":[360,361,362,363], 
    "layouts":[364,366], 
    "styles":[365], 
    "strings":[367], 
    "localizing":[367], 
